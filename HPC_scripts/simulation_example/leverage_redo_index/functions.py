...
def rasp_geo_index(adata,fraction = 0.1,seed = 0):
...
def rasp_scsampler_index(adata,fraction = 0.1,seed = 0):
...
def rasp_leverage_index(adata,fraction = 0.1,score_column="gene_score",seed = 0):
...
def leverage_pca_index(adata,fraction = 0.1,score_column="gene_score",seed = 0):
    #print("running leverage sampling")
    np.random.seed(seed)
