...
gene_scores_df = pd.read_csv('/dartfs-hpc/rc/lab/F/FrostH/members/igingerich/public_data/simulations_for_sketching_analysis/visium_like_data/complex/data/leverage_scores_pca.csv')
...
out_df.to_csv(f"/dartfs-hpc/rc/lab/F/FrostH/members/igingerich/public_data/simulations_for_sketching_analysis/visium_like_data/complex/sketching_test/combined_metrics/leverage_redo_metrics_seed_{seed}_{fraction}.csv")