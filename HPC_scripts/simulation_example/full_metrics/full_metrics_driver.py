...
out_df.to_csv(f"/dartfs-hpc/rc/lab/F/FrostH/members/igingerich/public_data/simulations_for_sketching_analysis/visium_like_data/complex/sketching_test/combined_metrics/normal_metrics_seed_{seed}_{fraction}.csv")